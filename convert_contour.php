...
$inputFile = "D:\\images\\outlineImg.png";
$outputEpsFile = "D:\\images\\outlineImg.eps";
...
$command = $inkscapePath . " " . escapeshellarg($inputFile) . " --actions=" . escapeshellarg("SelectAll;TraceBitmap;export-filename:" . $outputEpsFile . ";export-overwrite") . " --export-type=eps";
